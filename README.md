# Praticando PHP - Exercícios de Lógica

Este repositório contém a resolução de uma lista de 7 exercícios de lógica de programação desenvolvidos puramente na linguagem **PHP**. 
...
### Opção 1: Executar direto no Terminal (Mais Rápido)
Esta é a forma mais direta de ver o resultado da lógica pura. Abra o seu terminal ou prompt de comando, navegue até a pasta do projeto e execute o comando:
